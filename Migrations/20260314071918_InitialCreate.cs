        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BoarId = table.Column<int>(type: "INTEGER", nullable: false),
                    SowId = table.Column<int>(type: "INTEGER", nullable: false),
                    BreedingDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EstimatedBirthDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ActualBirthDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    WeaningDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LitterSizeAlive = table.Column<int>(type: "INTEGER", nullable: true),
                    LitterSizeDead = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BreedingRecords_Pigs_BoarId",
                        column: x => x.BoarId,
                        principalTable: "Pigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BreedingRecords_Pigs_SowId",
                        column: x => x.SowId,
                        principalTable: "Pigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PigHealthRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PigHealthRecords_Pigs_PigId",
                        column: x => x.PigId,
                        principalTable: "Pigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PigHealthRecords_PigId",
                table: "PigHealthRecords",
                column: "PigId");
